...
def plot_graph1():
    ...
    plt.xticks(range(len(df['Grande discipline'])), df['Grande discipline'],rotation=90)

    # Créer un graphique en barres avec les pourcentages de femmes
    plt.bar(range(len(df['Grande discipline'])), df['% femmes'])

    # Ajouter des étiquettes pour les axes et le titre
    plt.xlabel('Grande discipline')
    plt.ylabel('Pourcentage de femmes')
    plt.title('Pourcentage de femmes par grande discipline en 2022')
...
def plot_graph2():
    ...
    plt.xticks(range(len(df2['Discipline'])), df2['Discipline'],rotation=90)

    # Créer un graphique en barres avec les pourcentages de femmes
    plt.bar(range(len(df2['Discipline'])), df2['% femmes'])
...
def plot_graph3():
    ...
    plt.xticks(range(len(df3['Secteur disciplinaire'])), df3['Secteur disciplinaire'],rotation=90)

    # Créer un graphique en barres avec les pourcentages de femmes
    plt.bar(range(len(df3['Secteur disciplinaire'])), df3['% femmes'])
...
def plot_graph4():
    ...
    plt.xticks(range(len(df4['Diplôme'])), df4['Diplôme'],rotation=90)

    # Créer un graphique en barres avec les pourcentages de femmes
    plt.bar(range(len(df4['Diplôme'])), df4['% femmes'])
