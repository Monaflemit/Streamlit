...
# Ajouter un titre
st.title("Pourcentages de femmes dans les principaux diplômes préparés dans l'Enseignement supérieur")
...
def plot_graph1():
    ...
    plt.bar(range(len(df_grouped['Grande discipline'])), df_grouped['% femmes'])
...
def plot_graph2():
    ...
    # Créer un graphique en barres avec les pourcentages de femmes
    plt.bar(range(len(df_grouped['Discipline'])), df_grouped['% femmes'])
...
def plot_graph3():
    ...
    # Créer un graphique en barres avec les pourcentages de femmes
    plt.bar(range(len(df_grouped['Secteur disciplinaire'])), df_grouped['% femmes'])
...
def plot_graph4():    
    ...
    # Créer un graphique en barres avec les pourcentages de femmes
    plt.bar(range(len(df_grouped['Diplôme'])), df_grouped['% femmes'])
